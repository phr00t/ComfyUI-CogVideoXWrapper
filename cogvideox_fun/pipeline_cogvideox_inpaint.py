...
class CogVideoX_Fun_Pipeline_Inpaint(VideoSysPipeline):
    ...
    def prepare_latents(
        ...
        if latents is None:
            ...
            latents = latents * self.scheduler.init_noise_sigma if is_strength_max and hasattr(self.scheduler, 'init_noise_sigma') else latents
        else:
    ...
    def prepare_mask_latents(
        ...
        if masked_image is not None:
            if self.transformer.config.add_noise_in_inpaint_model and noise_aug_strength > 0:
